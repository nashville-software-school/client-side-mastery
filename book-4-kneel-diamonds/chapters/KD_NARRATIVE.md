...
```sh
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/nashville-software-school/client-side-mastery/e-15/book-4-kneel-diamonds/chapters/scripts/kneel-diamonds-setup.sh)"
```
