...
```sh
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/nashville-software-school/client-side-mastery/cohort-62/book-0-installations/chapters/scripts/installs-all-mac-users.sh)"
```
