...
```sh
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/nashville-software-school/client-side-mastery/cohort-50/book-3-deshawns-dog-walking/chapters/scripts/brewed-setup.sh)"
```
