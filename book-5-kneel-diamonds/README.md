...
| 7 |  | [Displaying Submissions with .map()](./chapters/IJ_SUBMISSIONS_COMPONENT.md) <br/> <sub style="font-size:0.85rem;">#component #map</sub> | [Saving Orders to Permanent State](./chapters/KD_POST_ORDER_TO_API.md) <br/> <sub style="font-size:0.85rem;">#fetch #POST</sub> |  |
