...
|--|--|--|--|--|
| 1 | [Introduction to API's](./chapters/FC_INTRO_TO_API.md) <br/> <sub style="font-size:0.85rem;">#API #Yaak</sub> | [Indiana Jeans](./chapters/IJ_INTRO.md) | [Kneel Diamonds](./chapters/KD_NARRATIVE.md) | [Cars 'R Us Data and ERD](./chapters/CB_SETUP.md) |
