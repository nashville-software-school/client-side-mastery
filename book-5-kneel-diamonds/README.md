...
| 3 | [First We "Fetch"](./chapters/FC_FIRST_FETCH.md) <br/> <sub style="font-size:0.85rem;">#fetch #devtools</sub> | [Owns Jeans Component](./chapters/IJ_JEANS_COMPONENT.md) <br/> <sub style="font-size:0.85rem;">#component</sub> | [Kneel Diamonds ERD](./chapters/KD_ERD.md) <br/> <sub style="font-size:0.85rem;">#data #ERD</sub> | [Modules and Components Setup](./chapters/CB_RADIO_BUTTONS.md) |
