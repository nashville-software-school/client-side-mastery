...
Create the files `components/animals/AnimalForm.js` and `components/animals/AnimalForm.css`.  Remember, you'll also have to `import` the new AnimalForm component once it's created. 
