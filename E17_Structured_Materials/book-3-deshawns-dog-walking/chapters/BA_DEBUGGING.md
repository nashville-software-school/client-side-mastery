...
```sh
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/nashville-software-school/client-side-mastery/e-15/book-3-deshawns-dog-walking/chapters/scripts/brewed-setup.sh)"
```
