...
| 7 | [Case Notes API - Making Entries](./chapters/GLASSDALE_NOTES_API.md) <br/> <sub style="font-size:0.85rem;">#fetch #POST #custom-events #user-input</sub> | [Entry API](./chapters/DAILY_JOURNAL_FETCHING.md) | [Food Ticket](./chapters/SF_FOOD_TICKET.md) | [Truncheons &amp; Flagons API](./chapters/TF_API.md) |
| 8 | [What's Your Alibi?](./chapters/GLASSDALE_ALIBI.md) <br/> <sub style="font-size:0.85rem;">#custom-events</sub> | [Journal Form Component](./chapters/DAILY_JOURNAL_FORM_COMPONENT.md) | [Game Tickets](./chapters/SF_GAME_TICKET.md) | [Adding Teams](./chapters/TF_FORMS.md) |
